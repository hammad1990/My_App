...
#### this module just export the final excel sheet pointlist################
class write_excel:
    def __init__(self,Project_Name,Unit_Name,names,type,object_id,device_id,object_name,read_write,unit,min1,max1,normal_state,desc):
...
################################ enter header with two ways ######
        ### WAY 1:
        sheet['A1'].value=self.Project_Name
        sheet['A1'].fill=PatternFill("solid",fgColor="F0F0F8")
        sheet['A2'].value=self.Unit_Name
        sheet['A2'].fill=PatternFill("solid",fgColor="F0F0F8")
        ...
        LOC="{}{}{}{}{}".format("Z:/M.hammad/PY/My_Apps/Excel files/output pointlist/",self.Project_Name," ",self.Unit_Name,".xlsx")
        wb.save(LOC)
        # time.sleep(4)
        # print(LOC)
        ### DOWNLOAD THE FILE
