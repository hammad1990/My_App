...
class mail_RFQ:
    def __init__(self,emails1,path,inquiry_number):
      ...
      #### email the attachemnt
        ...
        mailItem.CC="m-hammad@petra-eng.com.jo;procurementm@petra-eng.com.jo;B-ali@petra-eng.com.jo;k-ganim@petra-eng.com.jo;s-alwhiedi@petra-eng.com.jo;s-eid@petra-eng.com.jo"
